...
void SplitRule::apply(Object* obj, std::list<Object*>& stack) {
	...
	if (direction == DIRECTION_X) {
		decodeSplitSizes(obj->_scope.x, sizes, output_names, decoded_sizes, decoded_output_names);
	} else {
		decodeSplitSizes(obj->_scope.y, sizes, output_names, decoded_sizes, decoded_output_names);
	}
